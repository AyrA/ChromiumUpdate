...
namespace AyrA.IO
{
    ...
    {
        private enum ConsoleHandle : int
        {
            STD_INPUT_HANDLE = -10,
        ...
        /// <summary>
        /// Gets all console colors sorted from 0x0 to 0xF
        /// </summary>
        ...
        /// <summary>
        /// Gets if a console is present
        /// </summary>
		public static bool HasConsole
		{
			get
			{
				return GetStdHandle(ConsoleHandle.STD_INPUT_HANDLE) != IntPtr.Zero;
			}
		}
